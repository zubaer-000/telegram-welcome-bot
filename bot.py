...
def get_private_welcome_text(name):
    ...
    lines = [
        ...
        f"",
        f"তোমার টিএসএস আইডি দেখতে চাও?? ",
        f"ভিজিট করো",
        f"https://tinyurl.com/vwfk5kc8",
        f"",
        f"ঘুরে আসো আমাদের ফেসবুক পেজে",
        f"https://www.facebook.com/thakurgaonsciencesociety/",
        f"",
        f"ঘুরে আসো আমাদের মেইন সাইটে",
        f"🌐 Website:",
        ...
        f"অংশ নিতে পারবে আমাদের সাপ্তাহিক কুইজে",
        f"",
        f"🌐 Website:",
        ...
        f"",
        f"📋 Member List:",
        f"https://tinyurl.com/4nfph3vp",
        f"",
        f"📝 গিগাহার্টজের সদস্য হতে চাও? ফর্ম পূরণ করে ফেলো।যাচাই বাছাই করে উপযুক্ত মনে হলে আমরা সুযোগ দেবো।",
        f"https://tinyurl.com/2s4h9yn9",
        f"",
        f"━━━━━━━━━━━━━━━━━━━━━━━",
        ...
        f"",
        f"🌐 ফেসবুক পেজ লিংক :",
        f"https://www.facebook.com/profile.php?id=61570792858785",
        f"━━━━━━━━━━━━━━━━━━━━━━━",
        f"💻 <b>TSS::CodeBase</b> 💻",
        f"━━━━━━━━━━━━━━━━━━━━━━━",
        ...
        f"",
        f"━━━━━━━━━━━━━━━━━━━━━━━",
        f"🧪 <b>TSS::Chemi-Compound</b> 🧪",
        f"━━━━━━━━━━━━━━━━━━━━━━━",
        f"⚛︎ Chemistry related Section",
        f"",
        f"📌 শিখবে:",
        f"▪️ ক্যামিস্ট্রির মজার সব তথ্য",
        f"▪️ নিতে পারবে অলিম্পিয়াডের গাইডলাইন",
        f"",
        f"📢 Telegram:",
        f"https://t.me/+8UTQX58u3iw1Nzk1",
        f"",
        f"",
        f"━━━━━━━━━━━━━━━━━━━━━━━",
        f"☣︎ <b>তোমার বন্ধুরাও সদস্য হতে চায়?</b> ☣︎",
        f"━━━━━━━━━━━━━━━━━━━━━━━",
        f"তাদের সাধারণ সদস্য ফর্ম পূরণ করে সদস্য হয়ে যেতে বলো ",
        f"",
        f"🌐 Website:",
        f"https://tss-membership.blogspot.com/",
        f"",
        f"📢 ফর্ম লিংক:",
        f"https://tinyurl.com/3czckaw6",
        f"━━━━━━━━━━━━━━━━━━━━━━━",
        f"💬 <b>শেষ কথা</b>",
        f"━━━━━━━━━━━━━━━━━━━━━━━",
